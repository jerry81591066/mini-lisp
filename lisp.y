...
%left MPLY '/' 
%token <n> NUMBER 
%token <str> PLS MPLY PRTNUM DEFINE LAMBDA MOD IF PRTBOOL
%token <n> CMP EQL LOG 
%token <s> ID
%type <a> exp explist plus minus numop multiply divide lambdabody
%type <a> funcall modulus cmp equal ifexp logop lambdaexp
%type <sl> idlist lambdaid 
%type <n> line program
%type <pl> paramlist
%%
program : 	
